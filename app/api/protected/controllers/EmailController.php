                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" rowspan="3" bgcolor="#FFFFFF" style="padding:0 0 30px;">
                                                ...
                                                <p style="margin:0 30px 35px; font-size:12px; line-height:18px; color:#333333;">' . $request['title'] . '</p>




                                                <p style="margin:0; border-top:2px solid #e5e5e5; font-size:8px; line-height:5px; margin:0 30px 29px;">' . $request['content'] . '</p>
