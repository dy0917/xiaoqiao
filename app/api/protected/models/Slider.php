...
class Slider extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('imagelUrl, title, linkto', 'length', 'max'=>255),
			array('desc', 'length', 'max'=>2048),
			array('createtime, lastupdatetime', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('sliderId, imagelUrl, title, desc, linkto, createtime, lastupdatetime', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('imagelUrl',$this->imagelUrl,true);
